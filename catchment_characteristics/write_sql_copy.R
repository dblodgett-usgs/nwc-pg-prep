...
# cat("CREATE TABLE characteristic_data.characteristic_metadata (
#     characteristic_id text NOT NULL,
...
# );\r\n", file = "characteristic_data.characteristic_metadata.pgdump", append = TRUE)
