...
# curl -u dblodgett --insecure -X PUT "https://cidasdpdasartip.cr.usgs.gov:8444/artifactory/nldi/datasets/characteristic_data.characteristic_metadata.pgdump.gz" -T characteristic_data.characteristic_metadata.pgdump.gz -H "X-Checksum-Sha1:63620f28ec5a2d675882e9f953035f7875542131"
